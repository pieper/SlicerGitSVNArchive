...
#else
void qMRMLSliceWidgetPrivate::setImageDataConnection(vtkAlgorithmOutput * imageDataPort)
{
  //qDebug() << "qMRMLSliceWidgetPrivate::setImageDataConnection";
  this->SliceView->setImageDataConnection(imageDataPort);
}
#endif
...
#else
void qMRMLSliceWidget::setImageDataConnection(vtkAlgorithmOutput* newImageDataPort)
{
  Q_D(qMRMLSliceWidget);
  d->SliceController->setImageDataConnection(newImageDataPort);
}
#endif
