  ...
  switch (column)
    ...
    case qMRMLColorModel::LabelColumn:
      ...
      if (this->mrmlColorLogic() &&
        ...
        std::string category = this->mrmlColorLogic()->GetCategoryFromLabel(color, lutName);
        std::string catMod = this->mrmlColorLogic()->GetCategoryModifierFromLabel(color, lutName);
        std::string type = this->mrmlColorLogic()->GetCategoryTypeFromLabel(color, lutName);
        std::string region = this->mrmlColorLogic()->GetRegionFromLabel(color, lutName);
        std::string regionMod = this->mrmlColorLogic()->GetRegionModifierFromLabel(color, lutName);
